...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin Dashboard'); ?> - SIAPRAS</title>
    ...
    <div class="flex h-full">
        ...
        <aside id="sidebar"
            ...
            <div class="p-4 lg:p-6 border-b border-gray-100 shrink-0">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        <img src="<?php echo e(Vite::asset('resources/img/logo.png')); ?>" alt="Logo"
            ...
            <nav class="p-3 lg:p-4 space-y-1 overflow-y-auto flex-1">
                <a href="<?php echo e(route('admin.index')); ?>"
                    class="sidebar-link <?php echo e(request()->routeIs('admin.index') ? 'active' : ''); ?> flex items-center gap-3 px-3 lg:px-4 py-2.5 lg:py-3 rounded-xl font-medium text-sm lg:text-base mb-1">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="<?php echo e(route('admin.kategori.index')); ?>"
                    class="sidebar-link <?php echo e(request()->routeIs('admin.kategori.*') ? 'active' : 'text-gray-600'); ?> flex items-center gap-3 px-3 lg:px-4 py-2.5 lg:py-3 rounded-xl font-medium text-sm lg:text-base">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="<?php echo e(route('admin.ruangan.index')); ?>"
                    class="sidebar-link <?php echo e(request()->routeIs('admin.ruangan.*') ? 'active' : 'text-gray-600'); ?> flex items-center gap-3 px-3 lg:px-4 py-2.5 lg:py-3 rounded-xl font-medium text-sm lg:text-base">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="<?php echo e(route('admin.kelas.index')); ?>"
                    class="sidebar-link <?php echo e(request()->routeIs('admin.kelas.*') ? 'active' : 'text-gray-600'); ?> flex items-center gap-3 px-3 lg:px-4 py-2.5 lg:py-3 rounded-xl font-medium text-sm lg:text-base">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="<?php echo e(route('admin.barang.index')); ?>"
                    class="sidebar-link <?php echo e(request()->routeIs('admin.barang.*') ? 'active' : 'text-gray-600'); ?> flex items-center gap-3 px-3 lg:px-4 py-2.5 lg:py-3 rounded-xl font-medium text-sm lg:text-base">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="<?php echo e(route('admin.peminjaman.index')); ?>"
                    class="sidebar-link <?php echo e(request()->routeIs('admin.peminjaman.*') ? 'active' : 'text-gray-600'); ?> flex items-center gap-3 px-3 lg:px-4 py-2.5 lg:py-3 rounded-xl font-medium text-sm lg:text-base">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="<?php echo e(route('admin.pengaduan.index')); ?>"
                    class="sidebar-link <?php echo e(request()->routeIs('admin.pengaduan.*') ? 'active' : 'text-gray-600'); ?> flex items-center gap-3 px-3 lg:px-4 py-2.5 lg:py-3 rounded-xl font-medium text-sm lg:text-base">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="<?php echo e(route('admin.users.index')); ?>"
                    class="sidebar-link <?php echo e(request()->routeIs('admin.users.*') ? 'active' : 'text-gray-600'); ?> flex items-center gap-3 px-3 lg:px-4 py-2.5 lg:py-3 rounded-xl font-medium text-sm lg:text-base">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="<?php echo e(route('admin.laporan.index')); ?>"
                    class="sidebar-link <?php echo e(request()->routeIs('admin.laporan.*') ? 'active' : 'text-gray-600'); ?> flex items-center gap-3 px-3 lg:px-4 py-2.5 lg:py-3 rounded-xl font-medium text-sm lg:text-base">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
...
</html><?php /**PATH D:\laragon\www\PROJECT-UKK\resources\views/layouts/admin.blade.php ENDPATH**/ ?>