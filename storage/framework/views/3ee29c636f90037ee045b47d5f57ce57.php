...
<?php $__env->startSection('title', $barang->nama_barang . ' - Katalog'); ?>
    ...
    <div class="max-w-5xl mx-auto">
            ...
            <div class="md:flex">
                ...
                <div class="md:w-1/3 bg-gray-50 flex items-center justify-center p-8">
                    <?php if($barang->gambar): ?>
                        <img src="<?php echo e(Str::startsWith($barang->gambar, 'http') ? $barang->gambar : asset('storage/' . $barang->gambar)); ?>"
                            alt="<?php echo e($barang->nama_barang); ?>" class="max-h-64 object-contain rounded-lg">
                    <?php else: ?>
                ...
                <div class="md:w-2/3 p-6 md:p-8">
                    <div class="flex items-start justify-between mb-4">
                        <div>
                            <h1 class="text-2xl md:text-3xl font-bold text-gray-900 mb-2"><?php echo e($barang->nama_barang); ?></h1>
                    ...
                    <div class="grid grid-cols-2 gap-4 text-sm">
                        <div>
                            ...
                            <p class="font-semibold text-gray-900"><?php echo e($barang->ruangan->nama_ruangan ?? '-'); ?></p>
                        </div>
                        <div>
                            <p class="text-gray-500 mb-1">Stok Tersedia</p>
                            <p class="font-semibold <?php echo e($barang->jumlah_stok > 0 ? 'text-green-600' : 'text-red-500'); ?>">
                        ...
                        <div>
                            ...
                            <p class="font-semibold text-gray-900"><?php echo e($barang->units->count()); ?> Unit</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            ...
            <div class="divide-y divide-gray-100">
                <?php $__empty_1 = true; $__currentLoopData = $barang->units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php
                    ...
                    <div
                        ...
                        <div class="flex-1">
                            ...
                            <div class="flex flex-wrap gap-2">
                                <span class="text-xs px-2 py-1 rounded-full <?php echo e($kondisiClass); ?>">
                                    Kondisi: <?php echo e($unit->kondisi); ?>

                                </span>
                                <span class="text-xs px-2 py-1 rounded-full <?php echo e($statusClass); ?>">
                                    <?php if($isBorrowed): ?>
                                        Sedang Dipinjam
                                    <?php else: ?>
                                        Status: <?php echo e(ucfirst($unit->status)); ?>
                        ...
                        <div class="flex-shrink-0">
                            <?php if($isAvailable): ?>
                                <button onclick="addToCart(<?php echo e($unit->id); ?>)"
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\PROJECT-UKK\resources\views/main/katalog/show.blade.php ENDPATH**/ ?>