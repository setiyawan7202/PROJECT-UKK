...
<body class="h-screen w-screen overflow-hidden flex flex-col gradient-bg text-gray-900">

    <!-- Scrollable Content -->
    <div class="h-full w-full overflow-y-auto flex flex-col relative z-10">

        <!-- Main Content -->
        <main class="flex-1 flex flex-col items-center justify-start px-6 pt-20 pb-8">

            <!-- Hero Section -->
            <div class="flex flex-col md:flex-row items-center gap-10 md:gap-16 max-w-5xl mb-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl w-full fade-up fade-up-delay-5">
                <!-- Feature 1 -->
                <div
                    class="feature-card bg-white/70 backdrop-blur-sm border border-gray-100 rounded-2xl p-6 text-center">
                    <div
                        class="feature-icon w-14 h-14 bg-gray-100 rounded-xl flex items-center justify-center mx-auto mb-4">
                ...
                <div
                    ...
                    <p class="text-sm text-gray-500">Menampilkan data barang sekolah yang tersimpan dan terkelola
                        dengan
                        baik.</p>
                </div>
                ...
                <div
                    ...
                    <p class="text-sm text-gray-500">Berisi rangkuman data peminjaman barang sebagai dokumentasi.
                    </p>
                </div>
            </div>
        </main>
