...
<?php $__env->startSection('content'); ?>
    <div class="mb-6 flex items-center gap-4">
        <a href="<?php echo e(route('admin.peminjaman.index')); ?>" class="p-2 bg-white border border-gray-200 rounded-lg hover:bg-gray-50 transition">
        ...
        <div>
            ...
            <p class="text-sm text-gray-500">Kode: <span class="font-mono font-bold text-gray-900"><?php echo e($peminjaman->kode); ?></span></p>
        </div>
    </div>
            ...
            <div class="bg-white rounded-xl border border-gray-100 p-6 shadow-sm">
                ...
                <div class="flex gap-6">
                    <div class="w-24 h-24 bg-gray-100 rounded-lg overflow-hidden flex-shrink-0 border border-gray-200">
                        <?php if($peminjaman->barang->gambar): ?>
                            <img src="<?php echo e(asset('storage/' . $peminjaman->barang->gambar)); ?>" alt="<?php echo e($peminjaman->barang->nama_barang); ?>" class="w-full h-full object-cover">
                        <?php else: ?>
                    ...
                    <div class="flex-1">
                        <h4 class="font-bold text-lg text-gray-900"><?php echo e($peminjaman->barang->nama_barang); ?></h4>
                        <div class="text-sm text-gray-500 mb-2"><?php echo e($peminjaman->barang->kategori->nama_kategori ?? '-'); ?></div>
                        ...
                        <div class="grid grid-cols-2 gap-4 mt-4">
                            <div>
                                ...
                                <span class="font-mono text-sm font-semibold bg-gray-100 px-2 py-1 rounded">
                                    <?php echo e($peminjaman->barangUnit->kode_unit ?? 'Belum dialokasikan'); ?>

                                </span>
                            </div>
                            <div>
                                <span class="text-xs text-gray-500 block">Kondisi Awal</span>
                                <span class="text-sm font-medium"><?php echo e(ucfirst($peminjaman->barangUnit->kondisi ?? 'Baik')); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-6">
                    <div>
                        ...
                        <dd>
                            ...
                            ?>
                            <span class="px-3 py-1 rounded-md text-xs font-bold <?php echo e($statusColors[$peminjaman->status] ?? 'bg-gray-100'); ?>">
                    ...
                    <div>
                        ...
                        <dd class="text-sm font-medium"><?php echo e($peminjaman->created_at->format('d F Y, H:i')); ?></dd>
                    </div>
                    <div>
                        <dt class="text-xs text-gray-500 mb-1">Rencana Pinjam</dt>
                        <dd class="text-sm font-medium"><?php echo e($peminjaman->tgl_pinjam->format('d M Y')); ?></dd>
                    </div>
                    <div>
                        <dt class="text-xs text-gray-500 mb-1">Rencana Kembali</dt>
                        <dd class="text-sm font-medium"><?php echo e($peminjaman->tgl_kembali_rencana->format('d M Y')); ?></dd>
                    </div>
                    <div class="sm:col-span-2">
                        ...
                        <dd class="text-sm text-gray-700 bg-gray-50 p-3 rounded-lg border border-gray-100">
                            <?php echo e($peminjaman->tujuan_pinjam); ?>

                        </dd>
                    </div>
                    
                    <?php if($peminjaman->status == 'rejected'): ?>
                    <div class="sm:col-span-2">
                        ...
                        <dd class="text-sm text-red-700 bg-red-50 p-3 rounded-lg border border-red-100">
                            <?php echo e($peminjaman->keterangan_penolakan); ?>

                        </dd>
                    </div>
                    <?php endif; ?>

                    <?php if($peminjaman->status == 'completed' && $peminjaman->pengembalian): ?>
                    <div class="sm:col-span-2 mt-4 pt-4 border-t border-gray-100">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <span class="font-medium text-sm"><?php echo e($peminjaman->pengembalian->tgl_kembali->format('d F Y')); ?></span>
                            </div>
                            <div>
                                <span class="text-xs text-gray-500 block">Kondisi Akhir</span>
                                <span class="font-medium text-sm"><?php echo e(ucfirst($peminjaman->pengembalian->kondisi)); ?></span>
                            </div>
                            <?php if($peminjaman->pengembalian->denda > 0): ?>
                            <div>
                                <span class="text-xs text-gray-500 block">Denda</span>
                                <span class="font-bold text-red-600 text-sm">Rp <?php echo e(number_format($peminjaman->pengembalian->denda, 0, ',', '.')); ?></span>
                            </div>
                            <?php endif; ?>
                        </div>
                    </div>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-xl border border-gray-100 p-6 shadow-sm">
                ...
                <div class="flex items-center gap-4 mb-4">
                    <div class="w-12 h-12 rounded-full bg-gray-200 flex items-center justify-center text-gray-500 text-lg font-bold">
                        <?php echo e(substr($peminjaman->user->nama_lengkap, 0, 1)); ?>

                    </div>
                    <div>
                        <div class="font-bold text-gray-900"><?php echo e($peminjaman->user->nama_lengkap); ?></div>
                        <div class="text-xs text-gray-500"><?php echo e($peminjaman->user->email); ?></div>
                    </div>
                </div>
                <dl class="space-y-3">
                    <div class="flex justify-between">
                        <dt class="text-sm text-gray-500">Role</dt>
                        <dd class="text-sm font-medium"><?php echo e(ucfirst($peminjaman->user->role)); ?></dd>
                    </div>
                    <div class="flex justify-between">
                        <dt class="text-sm text-gray-500">Kelas/Jabatan</dt>
                        <dd class="text-sm font-medium">
                            <?php echo e($peminjaman->user->siswa->kelas->nama_kelas ?? ucfirst($peminjaman->user->role)); ?>

                        </dd>
                    </div>
                    <div class="flex justify-between">
                        <dt class="text-sm text-gray-500">No. Telepon</dt>
                        <dd class="text-sm font-medium"><?php echo e($peminjaman->user->no_in ?? '-'); ?></dd>
                    </div>
                </dl>
            </div>
            ...
            <div class="bg-white rounded-xl border border-gray-100 p-6 shadow-sm">
                ...
                <?php if($peminjaman->status == 'pending'): ?>
                    <div class="space-y-3">
                        <button onclick="openApproveModal('<?php echo e($peminjaman->id); ?>', '<?php echo e($peminjaman->barang->nama_barang); ?>', <?php echo e($peminjaman->barang->units->where('status', 'aktif')->pluck('kode_unit', 'id')); ?>)" 
                        ...
                        <button onclick="openRejectModal('<?php echo e($peminjaman->id); ?>')" 
                ...
                <?php elseif($peminjaman->status == 'approved'): ?>
                    <div class="space-y-3">
                        <div class="bg-gray-50 text-gray-800 border border-gray-100 p-3 rounded-lg text-xs leading-relaxed mb-3">
                            Peminjaman telah disetujui. Unit <strong><?php echo e($peminjaman->barangUnit->kode_unit); ?></strong> telah dialokasikan. Menunggu pengambilan barang.
                        </div>
                        <form action="<?php echo e(route('admin.peminjaman.activate', $peminjaman->id)); ?>" method="POST" onsubmit="return confirm('Konfirmasi pengambilan barang?')">
                            <?php echo csrf_field(); ?>
                        ...
                        <a href="<?php echo e(route('admin.peminjaman.bukti', $peminjaman->id)); ?>" target="_blank" class="block w-full text-center py-2.5 bg-white border border-gray-200 hover:bg-gray-50 text-gray-700 rounded-lg text-sm font-medium transition">
                            Cetak Bukti Peminjaman
                        </a>
                    </div>
                <?php elseif($peminjaman->status == 'active'): ?>
                    <div class="space-y-3">
                        <div class="bg-gray-50 text-gray-800 border border-gray-100 p-3 rounded-lg text-xs leading-relaxed mb-3">
                            Barang sedang dipinjam. Jatuh tempo pada <?php echo e($peminjaman->tgl_kembali_rencana->format('d M Y')); ?>.
                        </div>
                        <a href="<?php echo e(route('admin.peminjaman.return', $peminjaman->id)); ?>" class="block w-full text-center py-2.5 bg-black hover:bg-gray-800 text-white rounded-lg text-sm font-medium transition shadow-sm">
                            Proses Pengembalian
                        </a>
                        <a href="<?php echo e(route('admin.peminjaman.bukti', $peminjaman->id)); ?>" target="_blank" class="block w-full text-center py-2.5 bg-white border border-gray-200 hover:bg-gray-50 text-gray-700 rounded-lg text-sm font-medium transition">
                            Cetak Bukti Peminjaman
                ...
                <?php elseif($peminjaman->status == 'completed'): ?>
                    <div class="bg-gray-50 text-gray-600 border border-gray-200 p-4 rounded-lg text-center text-sm">
                        Peminjaman ini telah selesai.
                    </div>
                    <a href="<?php echo e(route('admin.peminjaman.bukti', $peminjaman->id)); ?>" target="_blank" class="block w-full text-center py-2.5 mt-3 bg-white border border-gray-200 hover:bg-gray-50 text-gray-700 rounded-lg text-sm font-medium transition">
                        Cetak Bukti Riwayat
                    </a>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\PROJECT-UKK\resources\views/admin/peminjaman/show.blade.php ENDPATH**/ ?>