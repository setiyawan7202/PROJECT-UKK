...
<?php $__env->startSection('content'); ?>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        ...
        <div class="flex gap-2">
            <a href="<?php echo e(route('admin.kelas.trash')); ?>"
    ...
    <div class="bg-white rounded-xl lg:rounded-2xl border border-gray-100 p-4 mb-4">
        <form method="GET" action="<?php echo e(route('admin.kelas.index')); ?>" class="flex flex-col lg:flex-row gap-4">
            <div class="flex-1">
                <div class="relative">
                ...
                <tbody class="divide-y divide-gray-100">
                    <?php $__empty_1 = true; $__currentLoopData = $kelasList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kelas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-4 lg:px-6 py-4">
                                <span class="text-sm text-gray-600 whitespace-nowrap"><?php echo e($kelas->jurusan); ?></span>
                            </td>
                            <td class="px-4 lg:px-6 py-4">
                                <span
                            ...
                            <td class="px-4 lg:px-6 py-4">
                                <span class="text-sm text-gray-600"><?php echo e($kelas->siswa_count ?? 0); ?> siswa</span>
                            </td>
                            <td class="px-4 lg:px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    <a href="<?php echo e(route('admin.kelas.edit', $kelas->id)); ?>"
                                    ...
                                    <form method="POST" action="<?php echo e(route('admin.kelas.destroy', $kelas->id)); ?>"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\PROJECT-UKK\resources\views/admin/kelas/index.blade.php ENDPATH**/ ?>