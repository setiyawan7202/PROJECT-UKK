...
<?php $__env->startSection('content'); ?>
    ...
    <div class="bg-white border border-gray-100 rounded-xl overflow-hidden">
        <div class="p-4 border-b border-gray-100">
            <form action="<?php echo e(route('admin.barang.index')); ?>" method="GET" class="flex flex-col md:flex-row gap-3">
                ...
                <div class="w-full md:w-48">
                    <select name="kategori_id"
                        ...
                        <?php $__currentLoopData = $kategoris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($cat->id); ?>" <?php echo e(request('kategori_id') == $cat->id ? 'selected' : ''); ?>>
                ...
                <div class="w-full md:w-48">
                    <select name="ruangan_id"
                        ...
                        <?php $__currentLoopData = $ruangans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($room->id); ?>" <?php echo e(request('ruangan_id') == $room->id ? 'selected' : ''); ?>>
                                <?php echo e($room->nama_ruangan); ?>
                ...
                <tbody class="divide-y divide-gray-100">
                    <?php $__empty_1 = true; $__currentLoopData = $barangs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $barang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50 transition">
                            <td class="px-6 py-4">
                                <span
                                    class="font-mono bg-gray-100 text-gray-800 px-2 py-1 rounded text-xs"><?php echo e($barang->kode ?? '-'); ?></span>
                            </td>
                            <td class="px-6 py-4">
                                <?php if($barang->gambar): ?>
                                    ...
                                    ?>
                                    <button onclick="showImageModal('<?php echo e($imageUrl); ?>', '<?php echo e($barang->nama_barang); ?>')"
                                        class="group cursor-pointer">
                                        <img src="<?php echo e($imageUrl); ?>" alt="<?php echo e($barang->nama_barang); ?>"
                            ...
                            <td class="px-6 py-4 font-medium text-gray-900">
                                ...
                                <div class="flex gap-1 mt-1">
                                    <span
                                        class="text-[10px] px-2 py-0.5 rounded-full <?php echo e($barang->jenis_aset == 'tik' ? 'bg-blue-100 text-blue-700' : 'bg-gray-100 text-gray-600'); ?>">
                                        <?php echo e($barang->jenis_aset == 'tik' ? 'TIK' : 'Non-TIK'); ?>

                                    </span>
                                    <span
                                        class="text-[10px] px-2 py-0.5 rounded-full <?php echo e($barang->tipe_barang == 'maintenance' ? 'bg-purple-100 text-purple-700' : 'bg-orange-100 text-orange-700'); ?>">
                            ...
                            <td class="px-6 py-4 text-gray-500">
                                <span
                                    class="bg-gray-100 text-gray-600 px-2 py-1 rounded text-xs"><?php echo e($barang->kategori->nama_kategori ?? '-'); ?></span>
                            </td>
                            <td class="px-6 py-4 text-gray-500"><?php echo e($barang->ruangan->nama_ruangan ?? '-'); ?></td>
                            <td class="px-6 py-4">
                                <span
                                    class="inline-flex items-center gap-1 font-medium <?php echo e($barang->units->count() == 0 ? 'text-red-500' : 'text-gray-900'); ?>">
                                    <?php echo e($barang->units->count()); ?> unit
                                </span>
                            </td>
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    <a href="<?php echo e(route('admin.barang.show', $barang->id)); ?>"
                                    ...
                                    <form action="<?php echo e(route('admin.barang.destroy', $barang->id)); ?>" method="POST"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\PROJECT-UKK\resources\views/admin/barang/index.blade.php ENDPATH**/ ?>