...
@section('content')
    <div class="max-w-2xl mx-auto">
        <!-- Header -->
        <div class="mb-6">
            <a href="{{ route('staff.kelas.index') }}"
            ...
            <h1 class="text-xl lg:text-2xl font-bold text-gray-900">Edit Kelas</h1>
        ...
        <!-- Form -->
        <form method="POST" action="{{ route('staff.kelas.update', $kelas->id) }}"
            ...
            <div class="mb-5">
                ...
                <select id="tingkat" name="tingkat" required
                    ...
                    <option value="XII" {{ old('tingkat', $kelas->tingkat) === 'XII' ? 'selected' : '' }}>XII (Kelas 12)
                    </option>
                </select>
            </div>
