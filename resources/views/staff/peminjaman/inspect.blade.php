...
@section('content')
    <div class="mb-6">
        <a href="{{ route('staff.peminjaman.show', $peminjaman->id) }}"
    ...
    @if($inspectionType)
        <div class="bg-white rounded-xl border border-gray-100 p-6">
            ...
            <form action="{{ route('staff.peminjaman.storeInspection', $peminjaman->id) }}" method="POST"
                ...
                @else
                    <div class="mb-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg text-yellow-700 text-sm">
                        Tidak ada template checklist untuk kategori ini. Hubungi Admin untuk membuat template.
                    </div>
                @endif
