    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="bg-black p-8 text-center text-white">
                ...
                <h2 class="text-xl font-bold"><?php echo e($user->nama_lengkap); ?></h2>
                <p class="text-gray-300"><?php echo e($user->email); ?></p>
                <div
                    ...
                    <span class="capitalize"><?php echo e($user->role); ?></span>
                    <?php if($user->kelas): ?>
                        <span>•</span>
                        <span><?php echo e($user->kelas->nama_kelas); ?></span>
                    <?php endif; ?>
                </div>
            </div>

            <form action="<?php echo e(route('profil.update')); ?>" method="POST" class="p-8 space-y-6">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\PROJECT-UKK\resources\views/main/profil/index.blade.php ENDPATH**/ ?>