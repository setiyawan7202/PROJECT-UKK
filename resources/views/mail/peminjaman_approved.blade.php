        ...
        <div
            ...
            <div style="padding: 40px;">
                ...
                <p style="color: #4b5563; line-height: 1.6; margin-bottom: 24px;">
                    ...
                    Pengajuan peminjaman barang Anda telah <strong>DISETUJUI</strong>. Silakan ambil barang sesuai
                ...
                <div
                    ...
                    <table style="width: 100%; border-collapse: collapse;">
                        ...
                        <tr>
                            <td style="padding: 8px 0; color: #6b7280; font-size: 14px;">Tanggal Pinjam</td>
                            <td style="padding: 8px 0; color: #111827; font-size: 14px; font-weight: 600;">
                                {{ $peminjaman->tgl_pinjam->format('d M Y') }}
                            </td>
                        </tr>
                        <tr>
                            <td style="padding: 8px 0; color: #6b7280; font-size: 14px;">Tanggal Kembali</td>
                            <td style="padding: 8px 0; color: #111827; font-size: 14px; font-weight: 600;">
