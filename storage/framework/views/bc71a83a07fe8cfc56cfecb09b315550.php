...
<?php $__env->startSection('content'); ?>
    ...
    <div class="bg-white rounded-xl lg:rounded-2xl border border-gray-100 p-4 mb-4">
        <form method="GET" action="<?php echo e(route('admin.users.index')); ?>" class="flex flex-col lg:flex-row gap-4">
            <!-- Search -->
            <div class="flex-1">
                <div class="relative">
            ...
            <div class="flex flex-wrap gap-2 items-center">
                <a href="<?php echo e(route('admin.users.index', ['search' => $search ?? ''])); ?>"
                    class="px-4 py-2 rounded-lg text-sm font-medium transition <?php echo e(!$filter && !$statusFilter && !$kelasFilter ? 'bg-black text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'); ?>">
                    Semua
                </a>
                <a href="<?php echo e(route('admin.users.index', ['filter' => 'admin', 'search' => $search ?? ''])); ?>"
                    class="px-4 py-2 rounded-lg text-sm font-medium transition <?php echo e($filter === 'admin' ? 'bg-black text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'); ?>">
                    Admin
                </a>
                <a href="<?php echo e(route('admin.users.index', ['filter' => 'petugas', 'search' => $search ?? ''])); ?>"
                    class="px-4 py-2 rounded-lg text-sm font-medium transition <?php echo e($filter === 'petugas' ? 'bg-black text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'); ?>">
                    Petugas
                </a>
                <a href="<?php echo e(route('admin.users.index', ['filter' => 'pengguna', 'search' => $search ?? ''])); ?>"
                    class="px-4 py-2 rounded-lg text-sm font-medium transition <?php echo e($filter === 'pengguna' ? 'bg-black text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'); ?>">
                    Pengguna
                </a>
                <span class="border-l border-gray-300 mx-1"></span>
                <a href="<?php echo e(route('admin.users.index', ['status' => 'siswa', 'search' => $search ?? ''])); ?>"
                    class="px-4 py-2 rounded-lg text-sm font-medium transition <?php echo e($statusFilter === 'siswa' ? 'bg-blue-600 text-white' : 'bg-blue-50 text-blue-600 hover:bg-blue-100'); ?>">
                    Siswa
                </a>
                <a href="<?php echo e(route('admin.users.index', ['status' => 'guru', 'search' => $search ?? ''])); ?>"
                    class="px-4 py-2 rounded-lg text-sm font-medium transition <?php echo e($statusFilter === 'guru' ? 'bg-green-600 text-white' : 'bg-green-50 text-green-600 hover:bg-green-100'); ?>">
                    Guru
                </a>
                <span class="border-l border-gray-300 mx-1"></span>
                <select name="kelas"
                    onchange="window.location.href='<?php echo e(route('admin.users.index')); ?>?kelas=' + this.value + '&search=<?php echo e($search ?? ''); ?>'"
                    ...
                    <?php $__currentLoopData = $kelasList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kelas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($kelas->id); ?>" <?php echo e($kelasFilter == $kelas->id ? 'selected' : ''); ?>>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50 transition">
                            <td class="px-4 lg:px-6 py-4">
                                <span class="text-sm text-gray-600 font-medium"><?php echo e($loop->iteration); ?></span>
                            </td>
                            <td class="px-4 lg:px-6 py-4">
                                <div>
                                    <p class="font-medium text-gray-900 text-sm whitespace-nowrap">
                                        <?php if($user->status == 'siswa' && $user->siswa): ?>
                                            <?php echo e($user->siswa->username); ?>

                                        <?php elseif($user->status == 'guru' && $user->guru): ?>
                                            <?php echo e($user->guru->username); ?>
                            ...
                            <td class="px-4 lg:px-6 py-4">
                                <span class="text-sm text-gray-600 whitespace-nowrap"><?php echo e($user->email); ?></span>
                            </td>
                            <td class="px-4 lg:px-6 py-4">
                                <span
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\PROJECT-UKK\resources\views/admin/users/index.blade.php ENDPATH**/ ?>