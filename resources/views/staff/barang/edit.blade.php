...
@section('content')
    <div class="max-w-3xl mx-auto">
        ...
        <div class="bg-white border border-gray-100 rounded-xl p-6 lg:p-8">
            <form action="{{ route('staff.barang.update', $barang->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
                @method('PUT')
            ...
            <div class="mt-8 pt-6 border-t border-gray-100">
                <div class="flex items-center justify-between">
                    ...
                    <form action="{{ route('staff.barang.destroy', $barang->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus barang ini? Semua data terkait akan hilang permanen.');">
                        @csrf
                        @method('DELETE')
