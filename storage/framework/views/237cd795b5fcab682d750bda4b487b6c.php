...
<?php $__env->startSection('content'); ?>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 lg:mb-8">
        <div>
            ...
            <p class="text-sm lg:text-base text-gray-500">Selamat datang,
                <?php echo e(Auth::user()->nama_lengkap ?? Auth::user()->email); ?>
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-6 mb-6 lg:mb-8">
        <div class="bg-white rounded-xl lg:rounded-2xl border border-gray-100 p-4 lg:p-6 card-hover">
            <div class="flex flex-col lg:flex-row lg:items-center gap-2 lg:gap-4">
                ...
                <div>
                    <p class="text-xl lg:text-2xl font-bold"><?php echo e($stats['total_barang']); ?></p>
        ...
        <div class="bg-white rounded-xl lg:rounded-2xl border border-gray-100 p-4 lg:p-6 card-hover">
            <div class="flex flex-col lg:flex-row lg:items-center gap-2 lg:gap-4">
                ...
                <div>
                    <p class="text-xl lg:text-2xl font-bold"><?php echo e($stats['total_user']); ?></p>
        ...
        <div class="bg-white rounded-xl lg:rounded-2xl border border-gray-100 p-4 lg:p-6 card-hover">
            <div class="flex flex-col lg:flex-row lg:items-center gap-2 lg:gap-4">
                ...
                <div>
                    <p class="text-xl lg:text-2xl font-bold"><?php echo e($stats['total_peminjaman']); ?></p>
        ...
        <div class="bg-white rounded-xl lg:rounded-2xl border border-gray-100 p-4 lg:p-6 card-hover">
            <div class="flex flex-col lg:flex-row lg:items-center gap-2 lg:gap-4">
                ...
                <div>
                    <p class="text-xl lg:text-2xl font-bold"><?php echo e($stats['pending_peminjaman']); ?></p>
            ...
            <?php $__empty_1 = true; $__currentLoopData = $recentActivities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="flex items-start gap-4 p-4 rounded-xl bg-gray-50 hover:bg-gray-100 transition">
                    <div class="w-10 h-10 rounded-full bg-blue-100 text-blue-600 flex items-center justify-center shrink-0 font-bold">
                        <?php echo e(substr($activity->user->nama_lengkap ?? $activity->user->email ?? 'S', 0, 1)); ?>

                    </div>
                    <div class="flex-1">
                        <p class="text-sm font-medium text-gray-900"><?php echo e($activity->description); ?></p>
                        <p class="text-xs text-gray-500 mt-1">
                            Oleh: <span class="font-medium text-gray-700"><?php echo e($activity->user->nama_lengkap ?? $activity->user->email ?? 'System'); ?></span>
                            &bull; <?php echo e($activity->created_at->diffForHumans()); ?>

                        </p>
                    </div>
                    <span class="px-2 py-1 text-[10px] font-medium uppercase tracking-wide rounded-full 
                        <?php echo e($activity->action == 'create' ? 'bg-green-100 text-green-700' : 
    ...
    <div class="bg-white rounded-xl lg:rounded-2xl border border-gray-100 p-4 lg:p-6 mt-6">
        <div class="flex justify-between items-center mb-4">
            ...
            <a href="<?php echo e(route('admin.peminjaman.index')); ?>" class="text-sm text-blue-600 hover:text-blue-700 font-medium">Lihat Semua</a>
        </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    <?php $__empty_1 = true; $__currentLoopData = $recentPeminjamans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pinjam): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50 transition">
                            <td class="px-4 py-3">
                                <span class="block font-medium text-gray-900">
                                    <?php echo e($pinjam->user->nama_lengkap ?? $pinjam->user->email); ?>

                                </span>
                                <span class="text-xs text-gray-500"><?php echo e($pinjam->user->role); ?></span>
                            </td>
                            <td class="px-4 py-3">
                                <span class="block text-gray-900"><?php echo e($pinjam->barang->nama_barang); ?></span>
                                <span class="text-xs text-gray-500"><?php echo e($pinjam->jumlah); ?> Unit</span>
                            </td>
                            <td class="px-4 py-3">
                                <span class="px-2 py-1 text-xs font-medium rounded-full
                                    <?php echo e($pinjam->status == 'approved' ? 'bg-green-100 text-green-700' : 
                            ...
                            <td class="px-4 py-3 text-right text-gray-500">
                                <?php echo e($pinjam->created_at->diffForHumans()); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\PROJECT-UKK\resources\views/admin/index.blade.php ENDPATH**/ ?>