...
@section('content')
    <div class="max-w-3xl mx-auto">
        ...
        <div class="bg-white border border-gray-100 rounded-xl p-6 lg:p-8">
            <form action="{{ route('staff.barang.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
                ...
                <div class="flex items-center gap-4 mt-8">
                    ...
                    <a href="{{ route('staff.barang.index') }}" class="text-gray-600 font-medium hover:text-gray-900">Batal</a>
                </div>
            </form>
        </div>
    </div>
