...
<?php $__env->startSection('content'); ?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
            ...
            <form action="<?php echo e(route('admin.laporan.peminjaman')); ?>" method="POST" target="_blank">
                <?php echo csrf_field(); ?>
                <div class="space-y-4">
                    <div>
        ...
        <div class="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
            ...
            <form action="<?php echo e(route('admin.laporan.pengaduan')); ?>" method="POST" target="_blank">
                <?php echo csrf_field(); ?>
                <div class="space-y-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Mulai Tanggal</label>
        ...
        <div class="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
            ...
            <div class="mt-auto">
                <a href="<?php echo e(route('admin.laporan.barang')); ?>" target="_blank"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\PROJECT-UKK\resources\views/admin/laporan/index.blade.php ENDPATH**/ ?>