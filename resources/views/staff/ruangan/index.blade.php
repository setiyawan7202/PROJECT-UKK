...
@section('content')
    <div class="mb-6 lg:mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        @if(Auth::user()->hasPermission('manage_ruangan'))
            <a href="{{ route('staff.ruangan.create') }}"
    ...
    <div class="bg-white border border-gray-100 rounded-xl overflow-hidden">
        <div class="p-4 border-b border-gray-100">
            <form id="searchForm" action="{{ route('staff.ruangan.index') }}" method="GET" class="flex gap-2">
                <div class="relative flex-1">
                    ...
                    <input type="text" id="searchInput" name="search" value="{{ request('search') }}" placeholder="Cari ruangan..."
            ...
            <table class="w-full text-left text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                            ...
                            @if(Auth::user()->hasPermission('manage_ruangan'))
                                <td class="px-6 py-4 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        <a href="{{ route('staff.ruangan.edit', $ruangan->id) }}"
                                        ...
                                        <form action="{{ route('staff.ruangan.destroy', $ruangan->id) }}" method="POST"
                    ...
                    @empty
                        <tr>
                        <tr>
                            <td colspan="{{ Auth::user()->hasPermission('manage_ruangan') ? '5' : '4' }}"
