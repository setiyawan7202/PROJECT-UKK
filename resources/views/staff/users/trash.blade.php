...
@section('content')
    <div class="mb-6 flex justify-between items-center">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Sampah User</h1>
            <p class="text-gray-600">Daftar user yang telah dihapus sementara.</p>
        </div>
                                ...
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4">
                                        ...
                                        @else
                                            {{ $user->username ?? '-' }}
                                        @endif
                                        <span class="block text-xs text-gray-400">{{ $user->data_nip_nisn ?? '' }}</span>
                                    </td>
