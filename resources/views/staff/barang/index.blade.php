            ...
            <table class="w-full text-left text-sm">
                <thead>
                    <tr class="bg-gray-50 text-gray-500 border-b border-gray-100">
                        ...
                        <th class="px-6 py-3 font-semibold text-xs uppercase">Stok</th>
                ...
                <tbody class="divide-y divide-gray-100">
                    @forelse($barangs as $barang)
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td
                                class="px-6 py-4 font-medium {{ $barang->jumlah_stok == 0 ? 'text-red-500' : 'text-gray-900' }}">
                                {{ $barang->jumlah_stok }}
                            </td>
                            <td class="px-6 py-4 text-gray-500">{{ $barang->kondisi_saat_ini }}</td>
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    <form action="{{ route('staff.barang.destroy', $barang->id) }}" method="POST"
