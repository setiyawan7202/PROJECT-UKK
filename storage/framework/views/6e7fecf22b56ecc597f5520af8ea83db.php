...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'SIAPRAS'); ?></title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-14 sm:h-16">
                ...
                <div class="flex items-center gap-2 sm:gap-3">
                    <a href="<?php echo e(route('main.index')); ?>" class="flex items-center gap-2 sm:gap-3">
                ...
                <div class="flex items-center gap-2 sm:gap-4">
                    <!-- Cart Icon -->
                    <a href="<?php echo e(route('cart.index')); ?>" class="relative p-2 text-gray-600 hover:text-black transition">
...
</html><?php /**PATH D:\laragon\www\PROJECT-UKK\resources\views/layouts/main.blade.php ENDPATH**/ ?>