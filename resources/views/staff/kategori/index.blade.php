...
@section('content')
    <div class="mb-6 lg:mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        @if(Auth::user()->hasPermission('manage_kategori'))
            <a href="{{ route('staff.kategori.create') }}"
    ...
    <div class="bg-white border border-gray-100 rounded-xl overflow-hidden">
        <div class="p-4 border-b border-gray-100">
            <form id="searchForm" action="{{ route('staff.kategori.index') }}" method="GET" class="flex gap-2">
                ...
                <tbody class="divide-y divide-gray-100">
                            ...
                            @if(Auth::user()->hasPermission('manage_kategori'))
                                <td class="px-6 py-4 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        <a href="{{ route('staff.kategori.edit', $kategori->id) }}"
                                        ...
                                        <form action="{{ route('staff.kategori.destroy', $kategori->id) }}" method="POST"
                    ...
                    @empty
                        <tr>
                            ...
                            <td colspan="{{ Auth::user()->hasPermission('manage_kategori') ? '4' : '3' }}"
