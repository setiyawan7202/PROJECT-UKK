...
<?php $__env->startSection('content'); ?>
    <div class="mb-6 lg:mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div class="flex gap-2">
            <a href="<?php echo e(route('admin.kategori.trash')); ?>"
    ...
    <div class="bg-white border border-gray-100 rounded-xl overflow-hidden">
        <div class="p-4 border-b border-gray-100">
            <form action="<?php echo e(route('admin.kategori.index')); ?>" method="GET" class="flex gap-2">
                ...
                <tbody class="divide-y divide-gray-100">
                    <?php $__empty_1 = true; $__currentLoopData = $kategoris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategori): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50 transition">
                            <td class="px-6 py-4 font-medium text-gray-900"><?php echo e($kategori->kode_kategori); ?></td>
                            <td class="px-6 py-4 text-gray-600"><?php echo e($kategori->nama_kategori); ?></td>
                            <td class="px-6 py-4 text-gray-500 truncate max-w-xs"><?php echo e($kategori->deskripsi ?? '-'); ?></td>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\PROJECT-UKK\resources\views/admin/kategori/index.blade.php ENDPATH**/ ?>