...
@section('content')
    <div class="max-w-3xl mx-auto">
        <div class="mb-6">
            ...
            <p class="text-sm text-gray-500">Tambahkan barang baru ke inventaris</p>
        </div>
        ...
        <div class="bg-white border border-gray-100 rounded-xl p-6 lg:p-8">
            <form action="{{ route('staff.barang.store') }}" method="POST" class="space-y-6">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select id="kondisi_saat_ini" name="kondisi_saat_ini"
                            ...
                            <option value="Rusak Ringan" {{ old('kondisi_saat_ini') == 'Rusak Ringan' ? 'selected' : '' }}>
                                Rusak Ringan</option>
                            <option value="Rusak Berat" {{ old('kondisi_saat_ini') == 'Rusak Berat' ? 'selected' : '' }}>Rusak
                                Berat</option>
                        </select>
                    </div>
                </div>
