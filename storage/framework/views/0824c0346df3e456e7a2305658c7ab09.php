...
<?php $__env->startSection('content'); ?>
    <div class="mb-6 lg:mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div class="flex gap-2">
            <a href="<?php echo e(route('admin.ruangan.trash')); ?>"
    ...
    <div class="bg-white border border-gray-100 rounded-xl overflow-hidden">
        <div class="p-4 border-b border-gray-100">
            <form action="<?php echo e(route('admin.ruangan.index')); ?>" method="GET" class="flex gap-2">
                <div class="relative flex-1">
                    ...
                    <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Cari ruangan..."
        ...
        <div class="overflow-x-auto w-full">
            <table class="w-full min-w-[800px] text-left text-sm whitespace-nowrap">
                ...
                <tbody class="divide-y divide-gray-100">
                    <?php $__empty_1 = true; $__currentLoopData = $ruangans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ruangan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50 transition">
                            <td class="px-6 py-4 font-medium text-gray-900"><?php echo e($ruangan->kode_ruangan); ?></td>
                            <td class="px-6 py-4 text-gray-600"><?php echo e($ruangan->nama_ruangan); ?></td>
                            <td class="px-6 py-4 text-gray-600"><?php echo e($ruangan->lokasi); ?></td>
                            <td class="px-6 py-4 text-gray-500 truncate max-w-xs"><?php echo e($ruangan->keterangan ?? '-'); ?></td>
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    <a href="<?php echo e(route('admin.ruangan.edit', $ruangan->id)); ?>"
                                    ...
                                    <form action="<?php echo e(route('admin.ruangan.destroy', $ruangan->id)); ?>" method="POST"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\PROJECT-UKK\resources\views/admin/ruangan/index.blade.php ENDPATH**/ ?>