...
@section('content')
    <div class="mb-6 flex items-center gap-4">
        <a href="{{ route('staff.pengaduan.index') }}" class="p-2 bg-white border border-gray-200 rounded-lg hover:bg-gray-50 transition">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-xl border border-gray-100 p-6 shadow-sm">
                    ...
                    @forelse($pengaduan->catatan as $catatan)
                        <div class="bg-gray-50 p-4 rounded-lg border border-gray-100">
                            <div class="flex justify-between items-start mb-2">
                                <span class="font-semibold text-gray-900">{{ $catatan->user->nama_lengkap ?? 'Petugas' }}</span>
                ...
                <form action="{{ route('staff.pengaduan.response', $pengaduan->id) }}" method="POST">
                    @csrf
                    <div class="mb-3">
        ...
        <div class="space-y-6">
            <div class="bg-white rounded-xl border border-gray-100 p-6 shadow-sm">
                ...
                <form action="{{ route('staff.pengaduan.status', $pengaduan->id) }}" method="POST">
                    @csrf
                    @method('PUT')
