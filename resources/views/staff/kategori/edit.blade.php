...
@section('content')
    <div class="max-w-xl mx-auto">
        ...
        <div class="bg-white border border-gray-100 rounded-xl p-6 lg:p-8">
            <form action="{{ route('staff.kategori.update', $kategori->id) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <textarea id="deskripsi" name="deskripsi" rows="3"
                        class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-1 focus:ring-black">{{ old('deskripsi', $kategori->deskripsi) }}</textarea>
                </div>
