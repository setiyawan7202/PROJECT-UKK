...
@section('content')
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        ...
        <div class="flex gap-2">
            @if(Auth::user()->hasPermission('manage_kelas'))
                <a href="{{ route('staff.kelas.create') }}"
    ...
    <div class="bg-white rounded-xl lg:rounded-2xl border border-gray-100 p-4 mb-4">
        <form method="GET" action="{{ route('staff.kelas.index') }}" class="flex flex-col lg:flex-row gap-4">
            <div class="flex-1">
                <div class="relative">
        ...
        <div class="overflow-x-auto w-full">
            <table class="w-full min-w-[800px] text-left text-sm whitespace-nowrap">
                ...
                <tbody class="divide-y divide-gray-100">
                            ...
                            @if(Auth::user()->hasPermission('manage_kelas'))
                                <td class="px-4 lg:px-6 py-4 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        <a href="{{ route('staff.kelas.edit', $kelas->id) }}"
                                        ...
                                        <form method="POST" action="{{ route('staff.kelas.destroy', $kelas->id) }}"
                    ...
                    @empty
                        <tr>
                            <td colspan="{{ Auth::user()->hasPermission('manage_kelas') ? '5' : '4' }}"
