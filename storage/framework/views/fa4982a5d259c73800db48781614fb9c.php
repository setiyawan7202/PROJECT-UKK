...
<?php $__env->startSection('content'); ?>
    <div class="max-w-xl mx-auto">
        ...
        <div class="bg-white border border-gray-100 rounded-xl p-6 lg:p-8">
            <form action="<?php echo e(route('admin.ruangan.store')); ?>" method="POST" class="space-y-6">
                <?php echo csrf_field(); ?>
                ...
                <div>
                    ...
                    <input type="text" id="kode_ruangan" name="kode_ruangan"
                        value="<?php echo e(old('kode_ruangan', $generatedKode)); ?>"
                ...
                <div>
                    <label for="lokasi" class="block text-sm font-medium text-gray-700 mb-2">Lokasi <span
                            class="text-red-500">*</span></label>
                    <input type="text" id="lokasi" name="lokasi" value="<?php echo e(old('lokasi')); ?>"
                        class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-1 focus:ring-black"
                ...
                <div>
                    ...
                    <textarea id="keterangan" name="keterangan" rows="3"
                        class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-1 focus:ring-black"><?php echo e(old('keterangan')); ?></textarea>
                </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\PROJECT-UKK\resources\views/admin/ruangan/create.blade.php ENDPATH**/ ?>