...
<?php $__env->startSection('content'); ?>
    <div class="max-w-xl mx-auto">
        ...
        <div class="bg-white border border-gray-100 rounded-xl p-6 lg:p-8">
            <form action="<?php echo e(route('admin.kategori.update', $kategori->id)); ?>" method="POST" class="space-y-6">
                <?php echo csrf_field(); ?>
                ...
                <div>
                    ...
                    <textarea id="deskripsi" name="deskripsi" rows="3"
                        class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-1 focus:ring-black"><?php echo e(old('deskripsi', $kategori->deskripsi)); ?></textarea>
                </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\PROJECT-UKK\resources\views/admin/kategori/edit.blade.php ENDPATH**/ ?>