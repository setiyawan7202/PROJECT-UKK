                ...
                <tbody class="divide-y divide-gray-100">
                    <?php $__empty_1 = true; $__currentLoopData = $ruangans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ruangan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 font-mono text-sm text-gray-600"><?php echo e($ruangan->kode_ruangan); ?></td>
                            <td class="px-6 py-4 font-medium text-gray-900"><?php echo e($ruangan->nama_ruangan); ?></td>
                            <td class="px-6 py-4 text-sm text-gray-600"><?php echo e($ruangan->lokasi); ?></td>
                            <td class="px-6 py-4 text-sm text-gray-600"><?php echo e($ruangan->deleted_at->format('d M Y H:i')); ?></td>
                            <td class="px-6 py-4 text-right flex justify-end gap-2">
                                <form action="<?php echo e(route('admin.ruangan.restore', $ruangan->id)); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                ...
                                <form action="<?php echo e(route('admin.ruangan.force_delete', $ruangan->id)); ?>" method="POST"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\PROJECT-UKK\resources\views/admin/ruangan/trash.blade.php ENDPATH**/ ?>